...
{
    public partial class Listas_Simples : Form
    {
        Pila pila = new Pila();
        Cola cola = new Cola();
        ...
        private void Vacia_Generico_button_Click(object sender, EventArgs e)
        {
            if (generica.Vacia())
                ...
                MessageBox.Show("La lista cuenta con "+ generica.Cantidad() +" elementos.");
        }
        ...
        private void Movimientos_Extras_button_Click(object sender, EventArgs e)
        {
            Genericas_Otros_Movimientos otros_movimientos = new Genericas_Otros_Movimientos();
            otros_movimientos.ShowDialog();

            switch (otros_movimientos.movimiento)
            {
                case 1:
                    generica.Insertar_Primera_Posicion(otros_movimientos.valor);
                    break;
                case 2:
                    generica.Insertar_Segunda_Posicion(otros_movimientos.valor);
                    break;
                case 3:
                    generica.Insertar_Antepenultima_Posicion(otros_movimientos.valor);
                    break;
                case 4:
                    generica.Insertar_Ultima_Posicion(otros_movimientos.valor);
                    break;
                case 5:
                    generica.Borrar_Primera_Posicion();
                    break;
                case 6:
                    generica.Borrar_Segunda_Posicion();
                    break;
                case 7:
                    generica.Borrar_Ultima_Posicion();
                    break;
                case 8:
                    generica.Borrar_Nodo_Mayor();
                    break;
                case 9:
                    generica.Ordenar_Mayor_Menor();
                    break;
                case 10:
                    generica.Ordenar_Menor_Mayor();
                    break;
                default:
                    break;
            }
